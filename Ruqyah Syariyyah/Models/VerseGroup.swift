...
struct VerseGroup: Identifiable, Codable, Hashable {
    ...
    static func formatGroupName(_ fileId: String) -> String {
        ...
        let specialNames: [String: String] = [
            ...
            "amalan_kendiri_02_ya_bariu": "Ya Bariu",
            "amalan_kendiri_03_surah_maryam_1": "Surah Maryam\n(1)",
            "amalan_kendiri_04_surah_ash_shura_1_2": "Surah Ash-Shura\n(1-2)",
            "amalan_kendiri_05_selawat_syifa": "Selawat Syifa",
            "amalan_kendiri_06_selawat_tafrijiyyah": "Selawat Tafrijiyyah",
            "amalan_kendiri_07_selawat_munjiyat": "Selawat Munjiyat",
            "amalan_kendiri_08_surah_al_baqarah_255_257": "Surah Al-Baqarah\n(255-257)",
            "amalan_kendiri_09_surah_al_hasyr_21_24": "Surah Al-Hasyr\n(21-24)",
            "amalan_kendiri_10_surah_al_mukminun_115_118": "Surah Al-Mu'minun\n(115-118)",
            "amalan_kendiri_11_ruqyah_jibril": "Ruqyah Jibril",
    ...
    var arabicName: String? {
        let arabicNames: [String: String] = [
            ...
            "Surah Maryam\n(1)": "سورة مريم",
            "Surah Ash-Shura\n(1-2)": "سورة الشورى",
            "Selawat Syifa": "صلوات الشفاء",
            "Selawat Tafrijiyyah": "صلوات التفريجية",
            "Selawat Munjiyat": "صلوات المنجيات",
            "Ruqyah Jibril": "رقية جبريل",
        ]
